...
it('can add the star name and star symbol properly', async() => {
    ...
    await instance.createStar(star1Name, starId, {from: user1});
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar(stname1, id1, {from: user1});
    await instance.createStar(stName2, id2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    let user2 = accounts[1];
    await instance.createStar(stname1, id1, {from: user1});
    await instance.transferStar(user2, id1);
    assert.equal(await instance.ownerOf.call(id1), user2);
});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let instance = await StarNotary.deployed();
    let stname1 = "Star1455";
    let id1 = 1455;
    let user1 = accounts[0];
    await instance.createStar(stname1, id1, {from: user1});
    let star = await instance.lookUptokenIdToStarInfo(id1);
    assert.equal(stname1, await star);
});